...
public class ConfigController extends BaseController {
	...
	public String deleteConfig(String type, Long projectId, String moduleName,String moduleId,int page, @PathVariable Long id) {
		configService.deleteConfig(id, projectId);
		
		String projCode = (String)projectService.queryProject(projectId).get("PROJ_CODE");
		diamondServerHandler.pushConfig(projCode, type, moduleName);
		return "redirect:/profile/" + type + "/" + projectId + "?moduleId="+moduleId+"&page=" + page;
	}
