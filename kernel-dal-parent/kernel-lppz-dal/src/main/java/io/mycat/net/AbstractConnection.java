...
//			program err:java.io.IOException: Connection reset by peer if("stream closed".equals(reason)){
			if(this instanceof ServerConnection){
				ServerConnection sc=(ServerConnection)this;
				CatSecondaryEsIndexHandler.getInstance().handlePostDml(sc.getSession2().getTransNo(), false);
			}
//			}
		}
	}
