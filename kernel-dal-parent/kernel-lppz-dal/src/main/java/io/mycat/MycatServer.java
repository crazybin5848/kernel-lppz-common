...
import io.mycat.sencondaryindex.es.EsClusterInitHandler;
...
public class MycatServer {
	...
	private MycatServer() {
		...
		//读取文件配置
		this.config = new MycatConfig(null,null);
	...
	public void beforeStart() throws IOException {
		...
		EsClusterInitHandler.getInstance().initEs(home);
		String kafkaBrokerPath=home+"/conf/kafka.properties";
		DalKafkaEsProducerProxy.getInstance().build(kafkaBrokerPath);
//		System.out.println();
//		JedisClusterUtil.getInstance().buildJedisCluster(home);
