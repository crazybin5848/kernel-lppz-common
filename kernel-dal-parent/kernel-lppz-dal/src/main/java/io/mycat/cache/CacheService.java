...
public class CacheService {
	...
	private void init() throws Exception {
		...
		File f=new File("configGen/cacheservice.properties");
		props.load(f.exists()?new FileInputStream(f):CacheService.class.getResourceAsStream("cacheservice.properties"));
