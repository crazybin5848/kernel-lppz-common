...
public final class SystemConfig {
	...
	public static final long DEFAULT_IDLE_TIMEOUT = 600 * 1000L;
	...
	private long sqlExecuteTimeout = 30000;
	...
	private int maxPacketSize = 128 * 1024 * 1024;
	...
	public SystemConfig() {
		...
		this.processors = 50;//DEFAULT_PROCESSORS;
		...
		this.processorExecutor = 100;//(DEFAULT_PROCESSORS != 1) ? DEFAULT_PROCESSORS * 2 : 4;
