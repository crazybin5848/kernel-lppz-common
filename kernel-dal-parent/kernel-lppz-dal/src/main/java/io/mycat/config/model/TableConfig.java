...
public class TableConfig {
	...
	private final String rootParentKey;
	private Set<String> secondaryIndexKeySet=new TreeSet<String>();

	public Set<String> getSecondaryIndexKeySet() {
		return secondaryIndexKeySet;
	}
	...
	public TableConfig(String name, String primaryKey, boolean autoIncrement,boolean needAddLimit, int tableType,
			...
			String parentKey,String subTables,String rootParentKey,Set<String> secondaryIndexKeySet) {
		if (name == null) {
		...
		this.secondaryIndexKeySet = secondaryIndexKeySet;
