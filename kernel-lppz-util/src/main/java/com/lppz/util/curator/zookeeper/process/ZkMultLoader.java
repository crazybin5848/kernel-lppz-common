package com.lppz.util.curator.zookeeper.process;
...
import com.lppz.util.curator.zookeeper.DataInf;
import com.lppz.util.curator.zookeeper.DiretoryInf;
...
public class ZkMultLoader {
    ...
    */
    ...
    protected void checkAndwriteString(String parentPath, String currpath, String value) throws Exception {
        ...
        if (null == stat) {
        	LOGGER.debug("ZkMultLoader create path {}",nodePath);
    ...
    protected DataInf getZkData(DiretoryInf zkDirectory, String name) {
        ...
        if (null != list && !list.isEmpty()) {
            for (Object directObj : list) {
                ...
                if (directObj instanceof ZkDataImpl && name.equals(((ZkDataImpl) directObj).getName())) {
                        return (ZkDataImpl) directObj;
                }
            }
        }
        return null;
    ...
    protected DiretoryInf getZkDirectory(DiretoryInf zkDirectory, String name) {
        ...
        if (null != list && !list.isEmpty()) {
            for (Object directObj : list) {
                ...
                if (directObj instanceof DiretoryInf && name.equals(((DiretoryInf) directObj).getDataName())) {
                        return (DiretoryInf) directObj;
                }
            }
        }
        return null;
