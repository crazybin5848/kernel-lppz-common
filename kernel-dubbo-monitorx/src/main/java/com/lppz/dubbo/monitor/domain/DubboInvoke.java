 ...
 */
package com.lppz.dubbo.monitor.domain;
...
public class DubboInvoke implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4914236279093999532L;
    ...
    public void buildTime(){
		...
		try {
			if(this.invokeDate!=null){
				this.invokeDateTime=format.format(invokeDate);
				this.invokeDate=null;
			}
