...
import com.lppz.dubbo.monitor.domain.DubboInvokeLineChart;
import com.lppz.dubbo.monitor.domain.LineChartSeries;
import com.lppz.dubbo.monitor.support.CommonResponse;
...
public class ChartsController {
    ...
    public CommonResponse loadChartsData(@ModelAttribute DubboInvoke dubboInvoke) {
        // 计算统计平均请求次数的时间粒度
        long timeParticle = 1;//dubboInvoke.getTimeParticle() / 1000;
